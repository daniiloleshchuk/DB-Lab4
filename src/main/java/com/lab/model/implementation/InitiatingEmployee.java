...
public class InitiatingEmployee implements IGeneralModel {
    private static final String tableName = InitiatingEmployee.class.getSimpleName();
    private Integer id;
    private Employee employeeByEmployeeId;

    public InitiatingEmployee() {
    }

    public InitiatingEmployee(final Integer id, final Employee employeeByEmployeeId) {
        this.id = id;
